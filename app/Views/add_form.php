...
<form class="tree-form">
  ...
  <div class="form-row">
    ...
    <div class="form-group">
      <label>Remarquable</label>
      <div class="radio-group">
        <label><input type="radio" name="remarquable" placeholder="oui" checked>Oui</label>
        <label><input type="radio" name="remarquable" placeholder="non">Non</label>
      </div>
    </div>
